# Assemble scenes/tesseract/build.py from tesseract_template.py + verbatim blocks of
# scenes/homestead/build.py. Run from anywhere:  python3 scenes/tesseract/gen_tesseract.py
import os
import re

HERE = os.path.dirname(os.path.abspath(__file__))
HS = open(os.path.join(HERE, '..', 'homestead', 'build.py'), encoding='utf-8').read()
T = open(os.path.join(HERE, 'tesseract_template.py'), encoding='utf-8').read()

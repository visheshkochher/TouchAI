# Assemble scenes/superposition/build.py from superposition_template.py + verbatim blocks of
# scenes/homestead/build.py. Run from anywhere:  python3 scenes/superposition/gen_superposition.py
import os
import re

HERE = os.path.dirname(os.path.abspath(__file__))
HS = open(os.path.join(HERE, '..', 'homestead', 'build.py'), encoding='utf-8').read()
T = open(os.path.join(HERE, 'superposition_template.py'), encoding='utf-8').read()
